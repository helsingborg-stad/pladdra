...
namespace Lean.Touch
{
    ...
    [ExecuteInEditMode]
    [HelpURL("Pladdra " + "PladdraDragTranslateAlong")]
    [AddComponentMenu("Pladdra " + "Drag Translate Along")]
    public class PladdraDragTranslateAlong : MonoBehaviour
    {
        ...
        /// <summary>The method used to find world coordinates from a finger. See PladdraScreenDepth documentation for more information.</summary>
        public PladdraScreenDepth ScreenDepth = new PladdraScreenDepth(PladdraScreenDepth.ConversionType.DepthIntercept);
...
{
    using TARGET = PladdraDragTranslateAlong;

    [UnityEditor.CanEditMultipleObjects]
    [UnityEditor.CustomEditor(typeof(TARGET))]
    public class PladdraDragTranslateAlong_Editor : LeanEditor
    {
